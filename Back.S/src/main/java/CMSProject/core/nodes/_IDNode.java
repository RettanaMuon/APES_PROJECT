...
public class _IDNode <T extends Asset> extends Collection {
    ...
    public _IDNode (Integer parent, ArrayList<Integer> childs, Document data, String counterName){
        this.name = null;
        this.parent = parent;
        this.childs = childs;
        this.data = data;
    ...
    public _IDNode (Integer parent, Document data, String counterName){
        this(parent, new ArrayList<Integer>(), data, counterName);
    }
    public _IDNode (Document data, String counterName){
        this((Integer)null, data, counterName);
    }    public _IDNode (String name, Integer parent, ArrayList<Integer> childs, Document data, String counterName){
        this.name = name;
        this.parent = parent;
        this.childs = childs;
        this.data = data;
    ...
    public _IDNode (String name, Integer parent, Document data, String counterName){
        this(name, parent, new ArrayList<Integer>(), data, counterName);
    }
    public _IDNode (String name, Document data, String counterName){
